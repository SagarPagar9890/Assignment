...
import com.jwttoken.entry.InvalidAuthenticationEntryPoint;
import com.jwttoken.filter.SecurityFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	// we should add Extra for - non form login concept (statelss)
	@Autowired
